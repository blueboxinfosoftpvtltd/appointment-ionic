...
export class AuthService {
  ...
  GetSearchCustomer(dealerid,fname,lname,cname,phno,vin,stockno){
    ...
    if(phno == '' || phno == undefined || phno == null){
      phno = ''
    }
    if(vin == '' || vin == undefined || vin == null){
      vin = ''
    } 
    if(stockno == '' || stockno == undefined || stockno == null){
      stockno = ''
    }
    let searchdata = {
...
updatetech(sno,rono,line,linedesc,tagno,storydesc,opcode,ltype,techno,shours,nline,dlrid){
  let techdata = {
    "SANumber":sno,
    "fkRONumber":rono,
    "Line":line,
