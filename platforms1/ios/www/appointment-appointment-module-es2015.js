...
let AppointmentPage = class AppointmentPage {
    constructor(events, storage, toastController, loadingController, authservice, popoverCtrl, modalCtrl, router) {
        this.events = events;
    ...
    Search() {
        if (this.fname == null || this.fname == '' || this.fname == undefined) {
            ...
            this.authservice.GetSearchCustomer(this.dealerid, this.fname, this.lname).subscribe(res => {
                this.res = res;
                console.log(this.res);
