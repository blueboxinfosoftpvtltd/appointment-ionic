...
var CreateappointmentPageModule = /** @class */ (function () {
    function CreateappointmentPageModule() {
    }
    ...
    return CreateappointmentPageModule;
}());
...
var CreateappointmentPage = /** @class */ (function () {
    function CreateappointmentPage(formBuilder, events, storage, authservice, modalCtrl, datepipe, router) {
    ...
    CreateappointmentPage.prototype.ngOnInit = function () {
        var _this = this;
        this.authservice.getcustidvin().subscribe(function (data) {
            console.log(data);
            _this.rescustvin = data;
            _this.CustomerId = _this.rescustvin.CustomerId;
            _this.VIN = _this.rescustvin.VIN;
        });
        this.storage.get('dealerid').then(function (val) {
            console.log('dealerid', val);
            _this.dealerid = val;
            _this.GetAdvisorList();
        });
        ...
        this.authservice.getadvisor().subscribe(function (advisorid) {
            // user and time are the same arguments passed in `events.publish(user, time)`
            _this.advisorid = advisorid;
        });
    };
    CreateappointmentPage.prototype.removeControl = function (control) {
    ...
    CreateappointmentPage.prototype.addControl = function (control) {
        console.log(control);
        var object1 = {
    ...
    CreateappointmentPage.prototype.ChangeSpeed = function (event, wtypename, wmainname) {
        this.WipersAndLightsList = [];
        console.log(event);
    };
    CreateappointmentPage.prototype.ChangeWheel = function (event) {
        console.log(event);
    ...
    CreateappointmentPage.prototype.ChangeTire = function (event) {
        console.log(event);
    ...
    CreateappointmentPage.prototype.activestep = function (op) {
        this.step = op;
        if (op == '1') {
            this.title = 'Customer Info';
            this.button1Color = '#009688';
    ...
    //for Customer Info
    CreateappointmentPage.prototype.getCountry = function () {
        var _this = this;
        this.authservice.GetCountry().subscribe(function (res) {
            _this.country = res;
            _this.countryid = _this.customerdata[0].CountryId;
            _this.getState();
            console.log(_this.country);
        });
    };
    CreateappointmentPage.prototype.GetCustomer = function () {
        var _this = this;
        this.authservice.presentLoading();
        this.authservice.GetCustomer(this.dealerid, this.CustomerId).subscribe(function (res) {
            _this.customerdata = res;
            _this.fname = _this.customerdata[0].FirstName;
            _this.lname = _this.customerdata[0].LastName;
            _this.saddress = _this.customerdata[0].Address1;
            _this.saddress1 = _this.customerdata[0].Address2;
            _this.zipcode = _this.customerdata[0].ZipCode;
            _this.mobile = _this.customerdata[0].MobilePhone;
            _this.workphone = _this.customerdata[0].WorkPhone;
            _this.homephone = _this.customerdata.HomePhone;
            _this.email = _this.customerdata[0].EmailId;
            console.log(_this.customerdata);
            _this.getCountry();
        });
    };
    CreateappointmentPage.prototype.ChangeCountry = function (event) {
        this.countryid = event.detail.value;
        console.log(this.countryid);
        this.getState();
    };
    CreateappointmentPage.prototype.getState = function () {
        var _this = this;
        this.authservice.GetState(this.countryid).subscribe(function (res) {
            _this.state = res;
            _this.stateid = _this.customerdata[0].StateId;
            _this.GetCity();
            console.log(_this.state);
        });
    };
    CreateappointmentPage.prototype.ChangeState = function (event) {
        this.stateid = event.detail.value;
        console.log(this.stateid);
        this.GetCity();
    };
    CreateappointmentPage.prototype.GetCity = function () {
        var _this = this;
        this.authservice.GetCity(this.stateid).subscribe(function (res) {
            _this.city = res;
            console.log("call again");
            if (_this.city != "" || _this.city != undefined) {
                _this.cityid = _this.customerdata[0].CityId;
            }
            _this.authservice.dismissLoading();
            console.log(_this.city);
        });
    };
    CreateappointmentPage.prototype.ChangeCity = function (event) {
        this.cityid = event.detail.value;
        console.log(this.cityid);
    };
    CreateappointmentPage.prototype.UpdateCustomerInfo = function () {
        var _this = this;
        if (this.fname == null || this.fname == '' || this.fname == undefined) {
            ...
            this.authservice.presentLoading();
            this.authservice.CustomerInsertUpdate(this.CustomerId, this.fname, this.lname, this.email, this.homephone, this.workphone, this.mobile, this.saddress, this.saddress1, this.countryid, this.cityid, this.stateid, this.zipcode, this.userid, this.dealerid).subscribe(function (res) {
                _this.res = res;
    ...
    CreateappointmentPage.prototype.getYears = function () {
        var _this = this;
    ...
    CreateappointmentPage.prototype.getMake = function () {
        var _this = this;
    ...
    CreateappointmentPage.prototype.getColors = function () {
        var _this = this;
    ...
    CreateappointmentPage.prototype.GetModelDetails = function () {
        var _this = this;
    ...
    CreateappointmentPage.prototype.GetTrimDetails = function () {
        var _this = this;
        this.authservice.GetTrimDetails().subscribe(function (res) {
            _this.trim = res;
            _this.GetVehicleDetailByVINCustomerID();
            console.log(_this.trim);
        });
    };
    CreateappointmentPage.prototype.ChangeYear = function (event) {
        this.yearid = event.detail.value;
        console.log(this.yearid);
    };
    CreateappointmentPage.prototype.ChangeMake = function (event) {
        this.makeid = event.detail.value;
        console.log(this.makeid);
    };
    CreateappointmentPage.prototype.ChangeModel = function (event) {
        this.modelid = event.detail.value;
        console.log(this.modelid);
    };
    CreateappointmentPage.prototype.ChangeTrim = function (event) {
        this.trimid = event.detail.value;
        console.log(this.trimid);
    };
    CreateappointmentPage.prototype.ChangeColor = function (event) {
        this.colorid = event.detail.value;
        console.log(this.colorid);
    };
    CreateappointmentPage.prototype.GetVehicleDetailByVINCustomerID = function () {
        var _this = this;
        this.authservice.GetVehicleDetailByVINCustomerID(this.dealerid, this.CustomerId, this.VIN).subscribe(function (res) {
            _this.vehicledata = res;
            _this.vin = _this.vehicledata[0].VIN;
            _this.yearid = _this.vehicledata[0].YearId;
            _this.makeid = _this.vehicledata[0].MakeId;
            _this.modelid = _this.vehicledata[0].ModelId;
            _this.trimid = _this.vehicledata[0].TrimId;
            _this.colorid = _this.vehicledata[0].ColorId;
            _this.mileage = _this.vehicledata[0].Milage;
            _this.avgmileage = _this.vehicledata[0].AverageMilesMonth;
            _this.licenseplate = _this.vehicledata[0].LicensePlate;
            _this.GetModelDetails();
        });
    };
    CreateappointmentPage.prototype.UpdateVehicleInfo = function () {
        var _this = this;
        if (this.vin == null || this.vin == '' || this.vin == undefined) {
            ...
            this.authservice.presentLoading();
            this.authservice.InsertVehicle(this.CustomerId, this.colorid, this.licenseplate, this.avgmileage, this.mileage, this.vin, this.makeid, this.yearid, this.modelid, this.trimid, this.userid, this.dealerid).subscribe(function (res) {
                _this.res = res;
                console.log(_this.res);
                _this.authservice.dismissLoading();
                _this.authservice.showToast(_this.res.Message);
    ...
    // for Maintainance
    CreateappointmentPage.prototype.AddNewOPCode = function () {
    ...
    CreateappointmentPage.prototype.GetMOPCode = function () {
        var _this = this;
        // this.authservice.presentLoading(); 
        this.authservice.GetMOPCode(this.dealerid, "1", "10", this.searchword).subscribe(function (res) {
            _this.codelist = res;
            console.log(_this.codelist);
            // this.authservice.dismissLoading();
        });
    };
    CreateappointmentPage.prototype.SearchOp = function () {
        var _this = this;
        // this.authservice.presentLoading(); 
        this.authservice.GetMOPCode(this.dealerid, "1", "10", this.searchword).subscribe(function (res) {
            _this.codelist = res;
    ...
    CreateappointmentPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
        this.from = this.page + 1;
        this.page = this.page + 10;
        setTimeout(function () {
            _this.authservice.GetMOPCode(_this.dealerid, _this.from, _this.page, _this.searchword)
                .subscribe(function (res) {
                _this.data = res;
                console.log(_this.data);
                for (var i = 0; i < _this.data.length; i++) {
                    _this.codelist.push(_this.data[i]);
                }
            }, function (error) { return console.log("eror"); });
            console.log(_this.codelist);
            console.log('Async operation has ended');
            infiniteScroll.target.complete();
        }, 1000);
    };
    CreateappointmentPage.prototype.toggleInfiniteScroll = function () {
        this.infiniteScroll.disabled = !this.infiniteScroll.disabled;
    };
    CreateappointmentPage.prototype.Next = function () {
    ...
    CreateappointmentPage.prototype.SelectOP = function (event, data) {
        var checked = 0;
        if (event.detail.checked == true) {
            this.opArray.push(data);
        }
        else {
            var newArray = this.opArray.filter(function (el) {
    ...
    // for Transportation
    CreateappointmentPage.prototype.TransNext = function () {
    ...
    CreateappointmentPage.prototype.GetTransportationList = function () {
        var _this = this;
        // this.authservice.presentLoading();    
        this.authservice.GetTransportationList(this.dealerid).subscribe(function (res) {
            _this.transportdata = res;
            console.log(_this.transportdata);
            _this.GetWeekDays();
            // this.authservice.dismissLoading();
        });
    };
    CreateappointmentPage.prototype.GetWheelsTiresDetails = function () {
        var _this = this;
        this.authservice.GetWheelsTiresDetails().subscribe(function (res) {
            console.log(res);
            _this.wheelsTireList = res;
            _this.lfront = _this.wheelsTireList.wheelsTireList[0].WheelTire;
            _this.lrear = _this.wheelsTireList.wheelsTireList[0].WheelTire;
            _this.rfront = _this.wheelsTireList.wheelsTireList[0].WheelTire;
            _this.rrear = _this.wheelsTireList.wheelsTireList[0].WheelTire;
            _this.WheelsTypeList = _this.wheelsTireList.WheelsTypeList;
            _this.wheelsDepthList = _this.wheelsTireList.wheelsDepthList;
        });
    };
    CreateappointmentPage.prototype.GetWipersAndLightsType = function () {
        this.authservice.GetWipersAndLightsType().subscribe(function (res) {
            console.log(res);
        });
    };
    CreateappointmentPage.prototype.GetWeekDays = function () {
        var _this = this;
        // this.authservice.presentLoading();    
        this.authservice.GetWeekDays().subscribe(function (res) {
            _this.weekdata = res;
            console.log(_this.weekdata);
            // this.authservice.dismissLoading();
        });
    };
    CreateappointmentPage.prototype.CalculateDealershipHRS = function () {
        var _this = this;
        // this.authservice.presentLoading();    
        this.authservice.CalculateDealershipHRS(this.dealerid, this.dayname, "value", this.userid).subscribe(function (res) {
            _this.dealershipdata = res;
            console.log(_this.dealershipdata);
            _this.totaldropoff = _this.dealershipdata[0].DropOffAppointmentLimit;
            _this.useddropoff = _this.dealershipdata[0].UsedAppt;
            _this.totalhrs = _this.dealershipdata[0].TotalHrsDuration;
            _this.totalusedhrs = _this.dealershipdata[0].UsedHRS;
            // this.authservice.dismissLoading();
        });
    };
    CreateappointmentPage.prototype.Selection = function (name, e) {
        console.log(name);
        console.log(e);
        this.tvalue = name;
        this.transportdata.forEach(function (x) {
            x.checked = false;
            console.log(name);
    ...
    CreateappointmentPage.prototype.ChangeWeekDay = function (event) {
        console.log(event);
        this.dayname = event.detail.value.DayName;
        this.CalculateDealershipHRS();
    };
    // for Advisor
    CreateappointmentPage.prototype.AdvisorNext = function () {
    ...
    CreateappointmentPage.prototype.GetAdvisorList = function () {
        var _this = this;
        // this.authservice.presentLoading();   
        this.authservice.GetAdvisorList(this.dealerid).subscribe(function (res) {
            _this.advisordata = res;
            console.log(_this.advisordata);
            // this.authservice.dismissLoading();
        });
    };
    CreateappointmentPage.prototype.AdvisorSelection = function (id, e) {
        console.log(id);
        console.log(e.detail.value);
        this.advisorid = id;
        this.advisordata.forEach(function (x) {
            x.checked = false;
    ...
    // For data/time
    CreateappointmentPage.prototype.DateNext = function () {
    ...
    CreateappointmentPage.prototype.GetTimeIntervals = function () {
        var _this = this;
        // this.authservice.presentLoading();
        this.authservice.GetTimeIntervals(this.dealerid, this.advisorid, this.sdate1).subscribe(function (res) {
            _this.intervaldata = res;
            console.log(_this.intervaldata);
            // this.authservice.dismissLoading();
            if (_this.intervaldata == null) {
                _this.authservice.showToast("Timeslots not available");
            }
        });
    };
    CreateappointmentPage.prototype.ChangeDate = function (event) {
        this.sdate1 = this.datepipe.transform(this.sdate, 'MM/dd/yyyy');
        console.log(this.sdate1);
        this.GetTimeIntervals();
    };
    CreateappointmentPage.prototype.ChangeTime = function (event) {
        console.log(this.interval);
        this.Promisetime = this.interval.TimeInerrvals;
        this.AppointmentTime = this.interval.AppointmentTimeId;
    };
    // for Notes
    CreateappointmentPage.prototype.BookAppointment = function () {
        var _this = this;
        ...
        if (this.opArray == '' || this.opArray == null || this.opArray == undefined) {
            ...
            this.authservice.InsertAppointment(this.dealerid, this.CustomerId, this.fname, this.lname, this.userid, "Pending", this.myForm.value.player1, this.sdate1, this.Promisetime, this.AppointmentTime, this.tvalue, this.colorid, this.licenseplate, this.avgmileage, this.mileage, this.VIN, this.makeid, this.yearid, this.modelid, this.trimid, this.opArray, this.lfw, this.lft, this.lrw, this.lrt, this.rfw, this.rft, this.rrw, this.rrt, this.WipersAndLightsList).subscribe(function (res) {
                console.log(res);
                _this.aptdata = res;
                _this.authservice.dismissLoading();
                _this.authservice.showToast("Appointment booked successfully !!");
                // this.router.navigateByUrl('/takeimage');
                _this.router.navigate(['/takeimage'], { queryParams: { AppointmentId: _this.aptdata.AppointmentId, VIN: _this.VIN, backpage: "true" }, replaceUrl: true });
            });
        }
    };
    CreateappointmentPage.ctorParameters = function () { return [
...
//# sourceMappingURL=createappointment-createappointment-module-es5.js.map