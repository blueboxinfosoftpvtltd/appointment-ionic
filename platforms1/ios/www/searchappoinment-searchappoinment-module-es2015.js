...
let SearchappoinmentPageModule = class SearchappoinmentPageModule {
};
...
let SearchappoinmentPage = class SearchappoinmentPage {
    constructor(file, videoEditor, mediaCapture, activatedRoute, authservice, storage, datepipe, router) {
        this.file = file;
            ...
            this.mediaCapture.captureVideo()
                ...
                this.file.copyFile(fromDirectory, fileName, toDirectory, fileName).then(res => {
                    ...
                    this.videoEditor.transcodeVideo({
                        ...
                        .then((fileUri) => console.log('video1 transcode success', fileUri))
                        .catch((error) => console.log('video1 transcode error', error));
                });
...
SearchappoinmentPage.ctorParameters = () => [
...
//# sourceMappingURL=searchappoinment-searchappoinment-module-es2015.js.map