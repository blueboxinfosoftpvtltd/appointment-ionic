...
let CreatecustPageModule = class CreatecustPageModule {
};
...
let CreatecustPage = class CreatecustPage {
    ...
    InsertCustomerInfo() {
        if (this.fname == null || this.fname == '' || this.fname == undefined) {
            ...
            this.authservice.InsertNewCustomer(this.dealerid, this.fname, this.lname, this.companyname, this.saddress, this.countryid, this.stateid, this.cityid, this.mobile, this.email, this.vin, this.username, this.password, this.saddress1, this.zipcode, this.homephone, this.workphone, this.yearid, this.makeid, this.modelid, this.trimid, this.colorid, this.mileage, this.avgmileage, this.licenseplate, this.userid).subscribe(res => {
                this.res = res;
...
//# sourceMappingURL=createcust-createcust-module-es2015.js.map