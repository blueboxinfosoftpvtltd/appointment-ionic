...
export class LoginPage  {
  ...
  type:any='password';
  constructor( public toastController: ToastController,private router: Router,public loadingController: LoadingController,private authservice:AuthService,public storage : Storage, public menuCtrl: MenuController) { 
  ...
  Login() {
    if(this.username == '' || this.username == undefined || this.username == null){
      ...
      if(this.res.Code == 200){
       ...
       if(this.res.DesignationName == "General Manager" || this.res.DesignationName ==="Bdc Service Advisor" || this.res.DesignationName == "GENERAL MANAGER" || this.res.DesignationName == "BDC SERVICS ADVISOR"){
        this.ISEnable = "false";
       }else{
        this.ISEnable = "true";
       }
       let object = {
        ...
        delaer : this.res.DefaultDealershipName
        }
