...
export class SignaturePage implements OnInit {
  ...
  resizeSignaturePad() {
    this.signaturePad.set(
      "canvasWidth",
      document.getElementById("sign_canvas").offsetWidth
    );
  ...
  async saveAppointmentData(data, email, text, val) {
    if (data.length == 0) {
      ...
      let uploadedCarImagespath = await this.uploadImages(
        appointmentdata,
        carImageList != null && carImageList != undefined ? carImageList : []
      ).then((data) => {
        return data;
      });
      let carImages = [
      ...
      const uploadedCarExtraImagesPath = await this.uploadImages(
        appointmentdata,
        carExtraImagesData
      ).then((data) => {
        return data;
      ...
      var signatureImagesPath = await this.uploadImages(
        appointmentdata,
        this.finalsignature
      ).then((data) => {
        return data;
      ...
      if (appointmentdata.AppointmentId == "") {
        this.authservice
          .InsertAppointment(
            ...
            appointmentdata.cname,
            appointmentdata.CreatedBy,
            appointmentdata.Status,
            appointmentdata.NotesList,
            appointmentdata.PromiseDate,
            appointmentdata.Promisetime,
            appointmentdata.AppointmentTime,
            appointmentdata.Transportation,
            appointmentdata.ColorId,
            appointmentdata.LicensePlate,
            appointmentdata.AverageMilesOrMonth,
            appointmentdata.Mileage,
            appointmentdata.VIN,
            appointmentdata.MakeId,
            appointmentdata.YearId,
            appointmentdata.ModelId,
            appointmentdata.TrimId,
            appointmentdata.OPCodeList,
            appointmentdata.LeftFrontwheel,
            appointmentdata.LeftFrontTire,
            appointmentdata.LeftRearwheel,
            appointmentdata.LeftRearTire,
            appointmentdata.RightFrontWheel,
            appointmentdata.RightFrontTire,
            appointmentdata.RightRearWheel,
            appointmentdata.RightRearTire,
            appointmentdata.WipersAndLightsList,
            appointmentdata.AppointmentId,
            appointmentdata.CreatedFor,
            appointmentdata.Vehicalemake,
            appointmentdata.Vehicalemodel,
            appointmentdata.CustomerEmail,
            appointmentdata.Vehicaleyear,
            appointmentdata.AdvisorName,
            email,
            text,
            appointmentdata.HomeNo,
            appointmentdata.WorkNo,
            appointmentdata.CellNo,
            appointmentdata.Zip,
